...
2. Doe hetzelfde voor de positievectoren $\vec{r}_B$ en $\vec{r}_C$. Gebruik weer het $\hat{i}, \hat{j}, \hat{k}$ co\"ordinatensysteem zoals afgebeeld in Figuur \ref{fig:prob81}. 
...
5. Als ten alle tijden geldt dat $\phi_1 = \phi_2$, hoe kan de beweging van punt $B$ ten opzichte van punt $O$ dan beschreven worden?
